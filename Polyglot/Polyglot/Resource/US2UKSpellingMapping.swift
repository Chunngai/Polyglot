...
let us2ukSpellingMapping: [String: String] = [  // US : UK. Ref: https://github.com/heiswayi/spelling-uk-vs-us/blob/gh-pages/data.txt
...
let us2ukSpellingMapping2: [String: String] = [  // Duplicated keys from the previous map.
    "anesthetize": "anaesthetise",
    "anesthetized": "anaesthetised",
    "anesthetizes": "anaesthetises",
    "anesthetizing": "anaesthetising",
